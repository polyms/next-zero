...
describe('Table Select Row', () => {
  ...
  it('should have correct className', () => {
    let tree = shallow(<TableSelectRow {...defaultProps} />);
    expect(tree.find('tr').hasClass('table-active')).toBeFalsy();

    tree = shallow(<TableSelectRow {...defaultProps} selected />);
    expect(tree.find('tr').hasClass('table-active')).toBeTruthy();
  });

  it('should pass className to the root element', () => {
    const tree = shallow(<TableSelectRow className="custom-class" />);
  ...
  it('should handle row click', () => {
    ...
    const tree = shallow(<TableSelectRow {...defaultProps} onToggle={onToggleMock} selectByRowClick />);
