    ...
    const cellLayout = (
      <th
        className={classNames(
          {
            'position-relative dx-g-nz-header-cell': true,
            'dx-g-nz-user-select-none': draggingEnabled,
            'dx-g-nz-cursor-pointer': draggingEnabled,
            'dx-g-nz-inactive': dragging || (tableColumn && tableColumn.draft),
