...
export const Container = ({ clientOffset, style, className, children, ...restProps }) => (
  <ul
    className={classNames('list-group d-inline-block position-fixed dx-g-nz-drag-drop', className)}
    style={{
