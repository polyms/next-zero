...
describe('Input search box', () => {
  ...
  it('should render input component with Value', () => {
    const tree = shallow(<SearchPanelInput {...defaultProps} value="abc" />);
  ...
  it('should pass the className prop to the root element', () => {
    const tree = shallow(<SearchPanelInput {...defaultProps} className="custom-class" />);

    expect(tree.is('.form-control.custom-class')).toBeTruthy();
  });

  it('should pass rest props to the root element', () => {
    const tree = shallow(<SearchPanelInput {...defaultProps} data={{ a: 1 }} />);
