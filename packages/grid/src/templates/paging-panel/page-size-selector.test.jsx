...
describe('PageSizeSelector', () => {
  describe('#render', () => {
    ...
    it('can show info about page sizes', () => {
      const tree = shallow(<PageSizeSelector {...defaultProps} />);
    ...
    it('can render the "All" item', () => {
      const tree = shallow(<PageSizeSelector {...defaultProps} pageSizes={[5, 10, 0]} />);
    ...
    it("can handle the 'onPageSizeChange' event", () => {
      ...
      const tree = shallow(
        <PageSizeSelector {...defaultProps} pageSizes={[5, 10, 0]} onPageSizeChange={onPageSizeChange} />
      );
