      ...
      <Draggable onStart={this.onResizeStart} onUpdate={this.onResizeUpdate} onEnd={this.onResizeEnd}>
        <div
          className={classNames({
            'dx-g-nz-resizing-control-wrapper': true,
            'dx-g-nz-resizing-control-wrapper-active': resizing,
          })}
        >
          <div
            className={classNames({
              'dx-g-nz-resize-control-line dx-g-nz-resize-control-line-first bg-primary': true,
              'dx-g-nz-resize-control-line-active': resizing,
            })}
          />
          <div
            className={classNames({
              'dx-g-nz-resize-control-line dx-g-nz-resize-control-line-second bg-primary': true,
              'dx-g-nz-resize-control-line-active': resizing,
            })}
          />
        </div>
