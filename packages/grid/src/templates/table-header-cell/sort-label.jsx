...
export const SortLabel = ({
  ...
  <span
    className={classNames(
      {
        'd-inline-flex flex-direction-row align-items-center mw-100 dx-g-nz-user-select-none': true,
  ...
  >
    {children}
    <SortingIndicator direction={direction} className={direction ? '' : 'dx-g-nz-sort-indicator-invisible'} />
  </span>
);
